package com.project250.applock.services;
...
import com.project250.applock.LockApplication;
import com.project250.applock.activities.lock.GestureUnlockActivity;
import com.project250.applock.base.AppConstants;
import com.project250.applock.db.CommLockInfoManager;
import com.project250.applock.receiver.LockRestarterBroadcastReceiver;
import com.project250.applock.utils.NotificationUtil;
...
public class LockService extends IntentService {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationUtil.createNotification(this, "Applock", "Applock running in background");
        }
